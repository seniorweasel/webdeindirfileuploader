...
function downloadFileByBaseFilename($baseFilename) {
    $files = glob('testDir/' . $baseFilename . '.*'); // Search for files with the given base filename

    if (!empty($files)) {
        $filename = basename($files[0]); // Get the full filename with extension
        $filePath = $files[0]; // Path to the file
...
if (isset($_GET['d'])) {
    $baseFilename = $_GET['d']; // Get the base filename from the query parameter
    downloadFileByBaseFilename($baseFilename);
}
...
<head>
    ...
    <title>Webdeindir File Uploader</title>
            ...
            <section class="hero text-center">
                <div class="container-sm">
                    <div class="hero-inner">
                        <h1 class="hero-title h2-mobile mt-0 is-revealing">Say welcome to Webdeindir Uploader v2.0!</h1>
                        <p class="hero-paragraph is-revealing">Faster. Open-Source. Anonymous. Easier. File sharing has never been that easy before.</p>
                       
                        <form action="<?php echo $slavemaster; ?>" method="post" enctype="multipart/form-data">
                        <div class="hero-form newsletter-form field field-grouped is-revealing">
                            <div class="control control-expanded">
                                <input class="input" type="file" name="<?php echo $fileeex; ?>" id="fileToUpload">
                                
                            </div>

                            <div class="control">
                                <input class="button button-primary button-block button-shadow" type="submit" value="Upload File!" name="submit">
                            </div>

                        </div>
                    </form>
                    <br>
                    <form action="<?php echo $pobierz; ?>" method="get" enctype="multipart/form-data">
                    <div class="hero-form newsletter-form field field-grouped is-revealing">
                        <div class="control control-expanded">
                            <input class="input" type="text" name="d" placeholder="Your Download ID&hellip;">
                        </div>
                        <div class="control">
                        <button class="button button-primary button-block button-shadow" type="submit">Receive File!</button>
                        </div>
                                    ...
                                    <div class="feature-icon">
                                        <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg">
                                            <g fill="none" fill-rule="evenodd">
                                                <path
                                                    d="M48.066 61.627c6.628 0 10.087-16.79 10.087-23.418 0-6.627-5.025-9.209-11.652-9.209C39.874 29 24 42.507 24 49.135c0 6.627 17.439 12.492 24.066 12.492z"
                                                    fill-opacity=".24" fill="#75ABF3" />
                                                <path d="M34 52V35M40 52V42M46 52V35M52 52V42M28 52V28" stroke="#4D8EF7"
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        ...
                        <div class="footer-form newsletter-form field field-grouped is-revealing">
                            ...
                            <div class="control">
                                <a class="button button-primary button-block button-shadow" href="#">Get early
                                    access</a>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="site-footer text-light">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2023 - Webdeindir File Upload <br> Theme: Ava</div>
                </div>
            </div>
        </footer>
    </div>
